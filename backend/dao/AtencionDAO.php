...
class AtencionDAO implements GenericDAO {
    ...
    public function actualizar($registro) {
        ...
        $query = "UPDATE ATENCION SET FECHA_ATENCION = :fecha_atencion, HORA_ATENCION = :hora_atencion, ESTADO = :estado, RUT_PACIENTE = :rut_paciente, RUT_MEDICO = :rut_medico WHERE ID_ATENCION = :id_atencion " ;
    ...
    public function agregar($registro) {
        ...
        $query = "INSERT INTO ATENCION (FECHA_ATENCION,HORA_ATENCION,ESTADO, RUT_PACIENTE, RUT_MEDICO) VALUES (:fecha_atencion, :hora_atencion, :estado, :rut_paciente, :rut_medico) ";
    ...
    public function listarPorParametro($idRegistro) {
        ...
        $atencion = null;
        $listado = array();
        $sentencia = $this->conexion->prepare("SELECT ID_ATENCION, FECHA_ATENCION, HORA_ATENCION, ESTADO, RUT_PACIENTE, RUT_MEDICO FROM ATENCION WHERE RUT_PACIENTE = :a_id");
